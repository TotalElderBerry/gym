		...
		<Container maxWidth="xl">
			<Box sx={{ height: '80vh'}} >
				<Stack>
					...
					<Stack>
						<Typography variant="h3" align="center" m={3} sx={{color:"#161e42", fontWeight: "300"}}>Start your Account</Typography>
						<Typography variant="subtitle1" align="center" mb={2} sx={{ color:"#333333", fontWeight: "100"}}>Be a Member</Typography>
					</Stack>  
					...
					<Box sx={{ width: '40%', display: "flex", justifyContent: "center" }} >
						<Paper sx={{width: "80%", padding: "50px", bgcolor: "#f2f6fe", display: "flex",flexDirection: "column", justifyContent: "space-between"}}>
							<Stack mb={4}>
								...
								<Typography variant="h4" sx={{color: "#1b3046"}}>Monthly Subscription</Typography>
							...
							<Stack spacing={1}>
								<Stack>
									...
									<Typography variant="body1" sx={{fontWeight: "500"}}>Subscription Payment</Typography>
									<Typography variant="subtitle1" sx={{fontWeight: "500", color: "#e22082"}}>800</Typography>
									</Stack>
									<Typography variant="overline" sx={{marginTop: "-5px", color: "#74849c"}}>Monthly</Typography>
								...
								<Stack>
									...
									<Typography variant="subtitle1" sx={{fontWeight: "500", color: "#e22082"}}>100</Typography>
									</Stack>
							...
							<Stack>
								...
								<Typography variant="h5" sx={{fontWeight: "700", color: "#e22082"}}>800</Typography>
								</Stack>
							</Stack>
							<Toolbar />
